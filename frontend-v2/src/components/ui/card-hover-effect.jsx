...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-black/40 border border-transparent dark:border-white/[0.1] group-hover:border-slate-700 relative z-20 backdrop-blur-sm",
        className
      )}
    >
